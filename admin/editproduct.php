...
$stkprice_db = $row['stkprice'];
$wholeprice_db = $row['wholeprice'];
$stock_db = $row['pstock'];
...
$sid = $supplier_db;
    ...
    function supplier_data($pdo ,$sid){
      $output='';
      $select = $pdo->prepare("SELECT * FROM tbl_supplier WHERE id=$sid");
      $select->execute();
...
if(isset($_POST['btnupdate'])){
    ...
    $stkprice_txt =  $_POST['txtstkprice']; 
    $wholeprice_txt =  $_POST['txtwholeprice']; 
    $stock_txt = $_POST['txtstock']; 
    $description_txt = $_POST['txtdescription'];
    $barcode_txt = $barcode;
    // $supplier_txt = $_POST['txtsupplier'];
    $expdate_txt = $_POST['txtexpdate'];
        ...
        if($f_extension == 'jpg' || $f_extension == 'png' || $f_extension == 'gif' || $f_extension == 'jpeg'){
            ...
            echo $error;
                ...
                if(move_uploaded_file($f_tmp, $store)){
                    $f_newfile;
                    if(!isset($error)){
                        $update = $pdo->prepare("UPDATE tbl_product SET pname=:pname,pcategory=:pcategory,purchaseprice=:pprice,saleprice=:saleprice,stkprice=:stkprice,wholeprice=:wholeprice,profit=:profit,pstock=:pstock,pdescription=:pdescription,pimage=:pimage,barcode=:barcode,supplier=:supplier,expiry_date=:expdate WHERE pid = $id");
        ...
        <div class="box box-warning">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="number" min="0" step="any" class="form-control" name="txtstkprice" value = "<?php echo $stkprice_db; ?>" placeholder="Price" required>
                </div>
                <div class="form-group">
                  <label >Wholesale price</label>
                  <input type="number" min="0" step="any" class="form-control" name="txtwholeprice" value = "<?php echo $wholeprice_db; ?>" placeholder="Price" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker1" value="<?php echo $expdate; ?>" name="txtexpdate" data-date-format="yyyy-mm-dd" autocomplete="off">
                  <br><br>
                </div>
