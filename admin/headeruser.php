  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($_SESSION['role'] == "Agent") { echo '<li><a href="agent.php"><i class="fa fa-dashboard"></i> <span>Agent Dashboard</span></a></li>'; } ?>
        <?php if($_SESSION['role'] != "Agent") { echo '<li><a href="user.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>'; } ?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="tablereport.php"><i class="fa fa-circle-o"></i> Table </a></li>
