...
function client_data($pdo, $cid)
{
  ...
  foreach ($result as $row) {
    ...
    if ($row["state"] == "jhr") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Johor</span></li>';
    }
    if ($row["state"] == "kdh") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Kedah</span></li>';
    }
    if ($row["state"] == "ktn") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Kelantan</span></li>';
    }
    if ($row["state"] == "kul") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Kuala Lumpur</span></li>';
    }
    if ($row["state"] == "lbn") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Labuan</span></li>';
    }
    if ($row["state"] == "mlk") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Melaka</span></li>';
    }
    if ($row["state"] == "nsn") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Negeri Sembilan</span></li>';
    }
    if ($row["state"] == "phg") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Pahang</span></li>';
    }
    if ($row["state"] == "prk") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Perak</span></li>';
    }
    if ($row["state"] == "png") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Penang</span></li>';
    }
    if ($row["state"] == "pls") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Perlis</span></li>';
    }
    if ($row["state"] == "pjy") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Putrajaya</span></li>';
    }
    if ($row["state"] == "srw") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Sarawak</span></li>';
    }
    if ($row["state"] == "sgr") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Selangor</span></li>';
    }
    if ($row["state"] == "trg") {
      echo '<li class="list-group-item">State <span class="label label-success pull-right" style="font-size:13px">Terengganu</span></li>';
    }
    echo '
...
if (isset($_POST['btnstatus'])) {
  ...
  if ($insert->execute()) {
    echo '<script type="text/javascript">
        ...
        setTimeout(function() {
          window.location = "order-view.php?id=' . $id . '";
      }, 3000);
        </script>';
  }
}
  ...
  <section class="content container-fluid">
    ...
    <div class="box box-warning">
      <div class="box-header with-border">
        <h3 class="box-title"><a href="order-list.php" class="btn btn-primary" role="button">Back To Order List</a></h3>
      </div>
