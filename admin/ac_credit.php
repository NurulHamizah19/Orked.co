...
if(isset($_POST['btncredit'])){
    ...
    $dc = "Credit";
    $payer = ($_POST['payee'] == null) ? "N/A" : $_POST['payee'];
   ...
   $f_name = $_FILES['myfile']['name']; // get file name
    ...
    if(!isset($error)){
      ...
      if($account == "Bank"){
        $insert = $pdo->prepare("INSERT INTO bank_ac(dc,tdate,detail,c_amount,name,reference,receipt) values(:dc,:tdate,:detail,:d_amount,:name,:reference,:receipt)");
        ...
        $insert = $pdo->prepare("INSERT INTO cash_ac(dc,tdate,detail,c_amount,name,reference,receipt) values(:dc,:tdate,:detail,:d_amount,:name,:reference,:receipt)");
        $insert->bindParam(':dc',$dc);
        $insert->bindParam(':tdate',$cbdate);
        $insert->bindParam(':detail',$detail);
        $insert->bindParam(':d_amount',$amount);
        ...
        <div class="box box-warning">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="cdate" value="<?php echo date("Y-m-d");?>" data-date-format="yyyy-mm-dd">
                </div>
                </div>
                <div class="form-group required">
            ...
            <div class="col-md-6">
            	<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="payee" id="payer">
                </div>
                <div class="form-group">
...
<center> 
                            <button type="submit" class="btn btn-info" name="btncredit">Proceed</button>
</center>
            </div>
            </form>
        </div>
