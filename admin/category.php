...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        ...
        if(isset($_POST['btnedit'])){
                  ...
                  <input type="hidden" class="form-control" name="txtid" value="'.$row->catid.'" placeholder="Category" >
                  <input type="text" class="form-control" name="txtcategory" value="'.$row->category.'" placeholder="Category" >
                </div>
