      ...
      <!--------------------------
        ...
        <div class="box box-warning">
            ...
            <h3 class="box-title"><a href="sales.php" class="btn btn-primary" role="button">Add Sales</a></h3>
                ...
                <?php if($_SESSION['role'] == "Admin") { echo '<h3 class="box-title"><a href="adm_orderlist.php" class="btn btn-info" role="button">View User List</a></h3>'; } else { echo ''; } ?>
                    ...
                    <tbody>
                        ...
                        while($row = $select->fetch(PDO::FETCH_OBJ)){
                          $cid = $row->customer_name;
                            ...
                            <td>'.$row->status.'</td>
                            <td>
                            <a href="vieworder.php?id='.$row->invoice_id.'" class="btn btn-info" role="button"><span class="glyphicon glyphicon-eye-open" style ="color:#fffff" data-toggle="tooltip" title="View Order"
                            </td></a>
                            <td>
