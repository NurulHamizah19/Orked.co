                        ...
                        <div class="row">
                                ...
                                <div class="card shadow-none mb-3 mb-lg-0 border">
                                    <div class="card-body">
                                        <div class="list-group list-group-flush"> <a href="dashboard.php" class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Dashboard <i class="bx bx-tachometer fs-5"></i></a>
                                            ...
                                            <a href="account-user-details.php" class="list-group-item active d-flex justify-content-between align-items-center">Account Details <i class="bx bx-user-circle fs-5"></i></a>
                            ...
                            <div class="col-lg-8">
                                <div class="card shadow-none mb-0 border">
                                    <div class="card-body">
                                        <form class="row g-3 updateDetails" method="POST" action="authenticate.php">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="email" id="email" class="form-control" value="<?= $userDetail['email']; ?>">
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <button type="submit" class="btn btn-dark submit disabled btn-ecomm">Save Changes</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
