                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <div class="position-relative overflow-hidden">
                                                ...
                                                <a href="javascript:;">
                                                    <img src="assets/images/products/22.png" class="img-fluid" alt="...">
                                                </a>
                                            </div>
                                            <div class="card-body px-0">
                                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <div class="position-relative overflow-hidden">
                                                ...
                                                <a href="javascript:;">
                                                    <img src="assets/images/products/21.png" class="img-fluid" alt="...">
                                                </a>
                                            </div>
                                            <div class="card-body px-0">
                                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <div class="position-relative overflow-hidden">
                                                ...
                                                <a href="javascript:;">
                                                    <img src="assets/images/products/20.png" class="img-fluid" alt="...">
                                                </a>
                                            </div>
                                            <div class="card-body px-0">
                                                <div class="d-flex align-items-center justify-content-between">
